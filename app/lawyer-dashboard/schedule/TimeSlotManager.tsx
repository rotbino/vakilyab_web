                    ...
                    <CardHeader>
                        <div className="flex justify-between items-center">
                            ...
                            <Button
                                ...
                                disabled={isLoading}
                                className="bg-orange-600 hover:bg-[#b02529] flex items-center gap-2"
                            >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                ...
                                <div className="flex items-end">
                                    <Button
                                        ...
                                        disabled={isLoading}
                                        className="w-full bg-orange-600 hover:bg-[#b02529]"
                                    >
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    {isHolidayFromTemplate(selectedDate) && (
                                        <Button
                                            ...
                                            size="sm"
                                            disabled={isLoading}
                                            className="text-orange-600 border-orange-600 hover:bg-[#fef2f2]"
                                        >
                                                    ...
                                                    {timeSlots
                                                        ...
                                                        .map(slot => (
                                                            <div key={slot.id} className="flex items-center gap-1">
                                                                <Badge
                                                                    className="bg-[#fef2f2] text-orange-600 px-3 py-1"
                                                                >
