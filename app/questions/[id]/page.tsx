...
import LegalQuestionCard from "@/app/questions/LegalQuestionCard";
                        ...
                        <>
                            <Card>
                                <CardContent className="p-4 flex items-center">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500">سوالات من</p>
                                        <p className="text-xl font-bold">{userStats?.totalQuestions || 0}</p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card>
                                <CardContent className="p-4 flex items-center">
                                    ...
                                    <div>
                                        <p className="text-sm text-gray-500">پاسخ‌های جدید</p>
                                        <p className="text-xl font-bold">{userStats?.newAnswersCount || 0}</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </>
